...
namespace AnalyzeInterference.Models
{
    internal class InterferenceAnalyzer
    {
        ...
        public (InterferenceResults AnalyzeResultsBoth, InterferenceResults AnalyzeResultsScrew) InterferenceAnalysisExcute(ObjectCollection ScrewComponentCollection,ObjectCollection NonScrewComponentCollection)
        {
            ...
            //InterferenceResults resultsNonScrew;
